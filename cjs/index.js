...
__export(esm_exports, {
  ...
  Blob: () => import_from.Blob,
  FetchError: () => import_fetch_error.FetchError,
  File: () => import_from.File,
  FormData: () => import_formdata_polyfill.FormData,
  Headers: () => import_headers.default,
  Request: () => import_request.default,
  Response: () => import_response.default,
  blobFrom: () => import_from.blobFrom,
  blobFromSync: () => import_from.blobFromSync,
  default: () => fetch,
  fileFrom: () => import_from.fileFrom,
  fileFromSync: () => import_from.fileFromSync,
...
var import_data_uri_to_buffer = __toESM(require("@esm2cjs/data-uri-to-buffer"), 1);
...
async function fetch(url, options_) {
  return new Promise((resolve, reject) => {
    const request = new import_request.default(url, options_);
    const { parsedURL, options } = (0, import_request.getNodeRequestOptions)(request);
    ...
    request_.on("response", (response_) => {
      ...
      const headers = (0, import_headers.fromRawHeaders)(response_.rawHeaders);
      if ((0, import_is_redirect.isRedirect)(response_.statusCode)) {
    ...
    (0, import_body.writeToStream)(request_, request).catch(reject);
  });
}
